...
export const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-10 h-80 w-80 rounded-full bg-accent-glow/20 blur-[140px] animate-float" style={{ animationDelay: "2s" }} />
      ...
      <div className="container-tight relative z-10 text-center">
        ...
        >
          Share Your Ideas
          <br />
          <span className="text-gradient-accent">With The World</span>
        </motion.h1>
        ...
        >
          Inkwell is the modern publishing platform for thinkers, writers, and
          creators who craft stories worth remembering.
        </motion.p>
